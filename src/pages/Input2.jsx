...
const Input2 = ({ hendleEnterAbout, hendleLeaveAbout, about }) => {
  return (
    <div
      className={` container w-full  backdrop-filter backdrop-blur-[5px] flex justify-end h-[95vh] z-10 dropDown  absolute top-14   ${
